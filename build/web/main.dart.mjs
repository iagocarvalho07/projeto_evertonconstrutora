...
_1593: x0 => x0.play(),
_1594: x0 => x0.pause(),
_1602: (x0,x1) => x0.removeAttribute(x1),
_1603: x0 => x0.load(),
_1604: (x0,x1) => x0.start(x1),
_1605: (x0,x1) => x0.end(x1),
_1606: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1607: (x0,x1) => x0.createElement(x1),
_1614: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1617: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1629: x0 => new Array(x0),
...
_1663: (decoder, codeUnits) => decoder.decode(codeUnits),
_1664: () => new TextDecoder("utf-8", {fatal: true}),
_1665: () => new TextDecoder("utf-8", {fatal: false}),
_1666: v => v.toString(),
_1667: (d, digits) => d.toFixed(digits),
_1671: x0 => new WeakRef(x0),
_1672: x0 => x0.deref(),
_1678: Date.now,
_1680: s => new Date(s * 1000).getTimezoneOffset() * 60 ,
_1681: s => {
...
_1683: () => typeof dartUseDateNowForTicks !== "undefined",
_1684: () => 1000 * performance.now(),
_1685: () => Date.now(),
_1686: () => {
...
_1688: () => new WeakMap(),
_1689: (map, o) => map.get(o),
_1690: (map, o, v) => map.set(o, v),
_1691: () => globalThis.WeakRef,
_1702: s => JSON.stringify(s),
_1703: s => printToConsole(s),
_1704: a => a.join(''),
_1705: (o, a, b) => o.replace(a, b),
_1707: (s, t) => s.split(t),
...
_1719: s => s.toLowerCase(),
_1720: (a, i) => a.push(i),
_1724: a => a.pop(),
_1725: (a, i) => a.splice(i, 1),
_1727: (a, s) => a.join(s),
_1728: (a, s, e) => a.slice(s, e),
_1731: a => a.length,
_1733: (a, i) => a[i],
_1734: (a, i, v) => a[i] = v,
...
_1794: o => Object.keys(o),
_1795: (ms, c) =>
              setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
_1796: (handle) => clearTimeout(handle),
_1797: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1798: (handle) => clearInterval(handle),
_1799: (c) =>
...
_1836: (x0,x1) => x0.exec(x1),
_1837: (x0,x1) => x0.test(x1),
_1838: (x0,x1) => x0.exec(x1),
_1839: (x0,x1) => x0.exec(x1),
_1840: x0 => x0.pop(),
_1844: (x0,x1,x2) => x0[x1] = x2,
_1846: o => o === undefined,
_1847: o => typeof o === 'boolean',
_1848: o => typeof o === 'number',
_1850: o => typeof o === 'string',
_1853: o => o instanceof Int8Array,
_1854: o => o instanceof Uint8Array,
_1855: o => o instanceof Uint8ClampedArray,
_1856: o => o instanceof Int16Array,
_1857: o => o instanceof Uint16Array,
_1858: o => o instanceof Int32Array,
_1859: o => o instanceof Uint32Array,
_1860: o => o instanceof Float32Array,
_1861: o => o instanceof Float64Array,
_1862: o => o instanceof ArrayBuffer,
_1863: o => o instanceof DataView,
_1864: o => o instanceof Array,
_1865: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1867: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1868: o => o instanceof RegExp,
_1869: (l, r) => l === r,
_1870: o => o,
_1871: o => o,
_1872: o => o,
...
_1874: o => o.length,
_1877: (o, i) => o[i],
_1878: f => f.dartFunction,
_1879: l => arrayFromDartList(Int8Array, l),
_1880: (data, length) => {
...
_1881: l => arrayFromDartList(Uint8ClampedArray, l),
_1882: l => arrayFromDartList(Int16Array, l),
_1883: l => arrayFromDartList(Uint16Array, l),
_1884: l => arrayFromDartList(Int32Array, l),
_1885: l => arrayFromDartList(Uint32Array, l),
_1886: l => arrayFromDartList(Float32Array, l),
_1887: l => arrayFromDartList(Float64Array, l),
_1888: (data, length) => {
...
_1889: l => arrayFromDartList(Array, l),
_1890:       (s, length) => {
        if (length == 0) return '';
...
_1918: x0 => x0.unicode,
_1919: x0 => x0.dotAll,
_1920: (x0,x1) => x0.lastIndex = x1,
_1963: x0 => x0.status,
_1964: (x0,x1) => x0.responseType = x1,
_1966: x0 => x0.response,
_2105: x0 => x0.style,
_2678: x0 => x0.videoWidth,
_2679: x0 => x0.videoHeight,
_2683: (x0,x1) => x0.playsInline = x1,
_2712: x0 => x0.error,
_2714: (x0,x1) => x0.src = x1,
_2723: x0 => x0.buffered,
_2726: x0 => x0.currentTime,
_2727: (x0,x1) => x0.currentTime = x1,
_2728: x0 => x0.duration,
_2733: (x0,x1) => x0.playbackRate = x1,
_2740: (x0,x1) => x0.autoplay = x1,
_2742: (x0,x1) => x0.loop = x1,
_2744: (x0,x1) => x0.controls = x1,
_2746: (x0,x1) => x0.volume = x1,
_2748: (x0,x1) => x0.muted = x1,
_2763: x0 => x0.code,
_2764: x0 => x0.message,
_2840: x0 => x0.length,
_3837: () => globalThis.window,
_3902: x0 => x0.navigator,
_4293: x0 => x0.userAgent,
_6619: () => globalThis.document,
_7063: (x0,x1) => x0.id = x1,
_11331: (x0,x1) => x0.border = x1,
_11773: (x0,x1) => x0.height = x1,
_12463: (x0,x1) => x0.width = x1,
_12840: x0 => x0.name,
_12841: x0 => x0.message,
_13598: () => globalThis.window.flutterCanvasKit,
_13599: () => globalThis.window._flutter_skwasmInstance
    };
